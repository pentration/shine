...
tpDistribution = '../../dat/ltu1/t-p.bin'
currentProfile = '../../dat/ltu1/current.dat'
nParticle = np.loadtxt('../../dat/ltu1/nParticle.dat',unpack=True)
...
plt1 = ep.enhancePlot(mt='o',ms=0.1,title='Longitudinal Phase Space - LTU1')
