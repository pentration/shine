...
file2 = open("../../dat/ltu3/current.dat")
file3 = open("../../dat/ltu3/current0.dat")
...
ax6.legend(l1,[r'End of LTU3',r'End of Linac'],bbox_to_anchor=(0.50,1.10),ncol=2)
fig6.savefig('../../fig/ltu3/ipk.eps')
