...
file3 = open("../../dat/ltu2/current0.dat")
...
ax6.legend(l1,[r'Exit of LTU2 dog-leg',r'Entrance of LTU3 septum'],bbox_to_anchor=(0.50,1.10),ncol=2)
fig6.savefig('../../fig/ltu2/ipk.eps')
