...
plt1 = ep.enhancePlot(title=r'$\beta$-functions and $x$-dispersion of LTU-2')
...
plt4 = ep.enhancePlot(axis=[r'$s\ (m)$',r'$\varepsilon_{x,y}\ (\mu{m}{\cdot}rad)$'],title='Norm. Emittance of LTU-2')
