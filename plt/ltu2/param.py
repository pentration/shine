...
s1,betax,betay,etax,etay,enx,eny,sigx,sigy,r56 = np.loadtxt('../../dat/ltu2/param.dat',usecols=(0,2,3,4,5,8,9,10,11,12),unpack=True,skiprows=2)
s2,prof = np.loadtxt('../../dat/ltu2/prof.dat',unpack=True,skiprows=1)
...
ax1.set_title(r'$\beta$-functions and dispersions of LTU-2',fontstyle='italic')
...
ax4.set_title(r'Norm. Emittance of LTU-2',fontstyle='italic',fontweight='bold')
...
ax40.set_xlim([ax4.get_xlim()[0],ax4.get_xlim()[1]])
ax40.set_xticks([])
ax40.set_yticks([])
...
ax50.set_xlim([ax5.get_xlim()[0],ax5.get_xlim()[1]])
ax50.set_xticks([])
ax50.set_yticks([])
